...
// Object[][] data;
// data = DataHelper.getTextFileData("src/main/resources/", "data.csv",
// TextFormat.CSV, true);
...
// Object[][] data;
// data = DataHelper.getTextFileData("src/main/resources/", "data.csv",
// TextFormat.CSV, true, Integer.TYPE,
// Boolean.TYPE);
// DisplayHelper.multArray(data);
// return data;
// }
...
// Object[][] data;
// data = DataHelper.getTextFileData("src/main/resources/", "data2.csv",
// TextFormat.CSV, true, String.class,
...
// Assert.assertEquals(actualResult, isPrime, "Number is not prime based on data
// set");
//
// }
//
...
// Assert.assertEquals(actualResult, Boolean.parseBoolean(isPrime), "Number is
// not prime based on data set.");
...
// public void testReadingFileTypedWithString(String title, int number, boolean
// isPrime) {
// System.out.println("Number " + number + ", is Prime? (" + isPrime + ")");
// boolean actualResult = isPrime(number);
// Assert.assertEquals(actualResult, isPrime, "Number is not prime based on data
